...
DUP_OUT ?= $(OUTDIR)/$(SAMPLE_LABEL).Rboth.rand.uniques.sorted.spotdups.txt
...
# java -jar $(PICARD_DIR)/MarkDuplicates.jar INPUT=$(SAMPLE_NAME).Rboth.rand.uniques.sorted.bam OUTPUT=$(SAMPLE_NAME).Rboth.rand.uniques.dup \
