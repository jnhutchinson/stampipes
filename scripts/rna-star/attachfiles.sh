...
$ATTACH_ALIGNMENT --attach_file anaquin_star/RnaAlign_sequins.csv --attach_file_purpose anaquin-rnaalign-star-sequins --attach_file_type plaintext
...
$ATTACH_ALIGNMENT --attach_file trimmed/{SAMPLE_NAME}.trimmed.R1.fastq --attach_file_purpose r1-fastq-trimmed --attach_file_type gzipped-fastq
$ATTACH_ALIGNMENT --attach_file trimmed/{SAMPLE_NAME}.trimmed.R2.fastq --attach_file_purpose r2-fastq-trimmed --attach_file_type gzipped-fastq
